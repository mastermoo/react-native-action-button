...
const ActionButton = (props) => {
  const [resetToken, setResetToken] = useState(props.resetToken);
  ...
  const getOverlayStyles = () => {
    return [
      styles.overlay,
      {
        ...
        zIndex: props.zIndex,
        justifyContent: props.verticalOrientation === "up"
          ? "flex-end"
          : "flex-start"
      }
    ];
  ...
  const _renderActions() {
    ...
    const actionStyle = {
      ...
      paddingTop: props.verticalOrientation === "down"
        ? props.spacing
        : 0,
      zIndex: props.zIndex
    };
  ...
  return (
    <View
      ...
      style={[getOverlayStyles(), props.style]}
    >
      <Animated.View
        pointerEvents="none"
        style={[
